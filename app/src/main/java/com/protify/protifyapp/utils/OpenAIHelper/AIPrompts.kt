...
class AIPrompts {
    ...
    fun comprehensivePromptWithOptimalEventOrder(hasRainingTimes: Boolean, nonRainingTimesString: String, optimalEventOrderString: String, dontRescheduleEvents: List<FirestoreEvent>, outdoorEventsString: String): String {
        return (
                if (hasRainingTimes && nonRainingTimesString.isNotEmpty()) {
                    "Prioritize scheduling the following events between $nonRainingTimesString: $outdoorEventsString. "
                } else {
                    ""
                }) +
    ...
    fun prioritizeEventOrderPrompt(hasRainingTimes: Boolean, nonRainingTimesString: String, dontRescheduleEvents: List<FirestoreEvent>, outdoorEventsString: String): String {
        return (
                if (hasRainingTimes && nonRainingTimesString.isNotEmpty()) {
                    "Prioritize scheduling the following events between $nonRainingTimesString: $outdoorEventsString. "
                } else {
